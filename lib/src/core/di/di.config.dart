...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i8.IGetCompanyAddress>(
        () => _i8.GetCompanyAddress(gh<_i6.ICompanyRepository>()));
    gh.factory<_i9.IGetCompanyName>(
        () => _i9.GetCompanyName(gh<_i6.ICompanyRepository>()));
    gh.factory<_i10.ISaveCompanyAddress>(
        () => _i10.SaveCompanyAddress(gh<_i6.ICompanyRepository>()));
    gh.factory<_i11.ISaveCompanyName>(
        () => _i11.SaveCompanyName(gh<_i6.ICompanyRepository>()));
    gh.factory<_i12.SettingsViewModel>(() => _i12.SettingsViewModel(
          gh<_i9.IGetCompanyName>(),
          gh<_i8.IGetCompanyAddress>(),
          gh<_i11.ISaveCompanyName>(),
          gh<_i10.ISaveCompanyAddress>(),
        ));
    return this;
  }
}
