...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i5.IPdfTemplateRepo>(() => _i5.PdfTemplateRepo());
    gh.singleton<_i6.IBankRepository>(
        _i6.BankRepository(gh<_i4.ILocalDataSource>()));
    gh.singleton<_i7.ICompanyRepository>(
        _i7.CompanyRepository(gh<_i4.ILocalDataSource>()));
    gh.factory<_i8.IGenerateInvoiceUseCase>(
        () => _i8.GenerateInvoiceUseCase(gh<_i5.IPdfTemplateRepo>()));
