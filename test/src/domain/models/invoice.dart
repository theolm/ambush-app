...
void main() {
  group('Invoice', () {
    test(
        'Given a complete address, when formattedAddress is called, then it should return the properly formatted address',
        () {
...
Zip-code: 13.025-270\n''';
    ...
    test(
        'Given quantity 2.0 and price 50.0, when formattedQuantity is called, then it should return 2',
        () {
    ...
    test(
        'Given quantity 2.0 and price 50.0, when formattedPrice is called, then it should return US\$ 50.00',
        () {
      final serviceInfo = testServiceInfo.copyWith(quantity: 2.0, price: 50.0);
      final invoice = testInvoice.copyWith(service: serviceInfo);
    ...
    test(
        'Given quantity 2.0 and price 50.0, when formattedTotalPrice is called, then it should return US\$ 100.000',
        () {
      final serviceInfo = testServiceInfo.copyWith(quantity: 2.0, price: 50.0);
      final invoice = testInvoice.copyWith(service: serviceInfo);
    ...
    test(
        'Given quantity 0.0 and price 50.0, when formattedQuantity and formattedTotalPrice are called, then they should return 0 and US\$ 0.00 respectively',
        () {
    ...
    test(
        'Given quantity 1.0 and price 1000.0, when formattedQuantity and formattedTotalPrice are called, then they should return 0 and US\$ 1,000.00 respectively',
        () {
      final serviceInfo =
          testServiceInfo.copyWith(quantity: 1.0, price: 1000.0);
      final invoice = testInvoice.copyWith(service: serviceInfo);
    ...
    test(
        'Given quantity 2.0 and price 0.0, when formattedPrice and formattedTotalPrice are called, then they should return 0.00 and US\$ 0.00 respectively',
        () {
